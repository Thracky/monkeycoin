...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("MonkeyCoin Core monkeycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  monkeycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded monkeycoin transaction") + "\n" +
              "  monkeycoin-tx [options] -create [commands]   " + _("Create hex-encoded monkeycoin transaction") + "\n" +
              "\n";
